...
/*
 * Macros for device 'pesos', class 'altera_avalon_onchip_memory2'
 * The macros are prefixed with 'PESOS_'.
 * The prefix is the slave descriptor.
 */
#define PESOS_COMPONENT_TYPE altera_avalon_onchip_memory2
#define PESOS_COMPONENT_NAME pesos
#define PESOS_BASE 0xc0000000
#define PESOS_SPAN 256
#define PESOS_END 0xc00000ff
#define PESOS_ALLOW_IN_SYSTEM_MEMORY_CONTENT_EDITOR 0
#define PESOS_ALLOW_MRAM_SIM_CONTENTS_ONLY_FILE 0
#define PESOS_CONTENTS_INFO ""
#define PESOS_DUAL_PORT 0
#define PESOS_GUI_RAM_BLOCK_TYPE AUTO
#define PESOS_INIT_CONTENTS_FILE kdata
#define PESOS_INIT_MEM_CONTENT 1
#define PESOS_INSTANCE_ID NONE
#define PESOS_NON_DEFAULT_INIT_FILE_ENABLED 1
#define PESOS_RAM_BLOCK_TYPE AUTO
#define PESOS_READ_DURING_WRITE_MODE DONT_CARE
#define PESOS_SINGLE_CLOCK_OP 0
#define PESOS_SIZE_MULTIPLE 1
#define PESOS_SIZE_VALUE 256
#define PESOS_WRITABLE 1
#define PESOS_MEMORY_INFO_DAT_SYM_INSTALL_DIR SIM_DIR
#define PESOS_MEMORY_INFO_GENERATE_DAT_SYM 1
#define PESOS_MEMORY_INFO_GENERATE_HEX 1
#define PESOS_MEMORY_INFO_HAS_BYTE_LANE 0
#define PESOS_MEMORY_INFO_HEX_INSTALL_DIR QPF_DIR
#define PESOS_MEMORY_INFO_MEM_INIT_DATA_WIDTH 32
#define PESOS_MEMORY_INFO_MEM_INIT_FILENAME kdata

/*
 * Macros for device 'ocr', class 'altera_avalon_onchip_memory2'
 * The macros are prefixed with 'OCR_'.
 * The prefix is the slave descriptor.
 */
#define OCR_COMPONENT_TYPE altera_avalon_onchip_memory2
#define OCR_COMPONENT_NAME ocr
#define OCR_BASE 0xc0001000
#define OCR_SPAN 4096
#define OCR_END 0xc0001fff
#define OCR_ALLOW_IN_SYSTEM_MEMORY_CONTENT_EDITOR 0
#define OCR_ALLOW_MRAM_SIM_CONTENTS_ONLY_FILE 0
#define OCR_CONTENTS_INFO ""
#define OCR_DUAL_PORT 0
#define OCR_GUI_RAM_BLOCK_TYPE AUTO
#define OCR_INIT_CONTENTS_FILE soc_system_ocr
#define OCR_INIT_MEM_CONTENT 1
#define OCR_INSTANCE_ID NONE
#define OCR_NON_DEFAULT_INIT_FILE_ENABLED 0
#define OCR_RAM_BLOCK_TYPE AUTO
#define OCR_READ_DURING_WRITE_MODE DONT_CARE
#define OCR_SINGLE_CLOCK_OP 0
#define OCR_SIZE_MULTIPLE 1
#define OCR_SIZE_VALUE 4096
#define OCR_WRITABLE 1
#define OCR_MEMORY_INFO_DAT_SYM_INSTALL_DIR SIM_DIR
#define OCR_MEMORY_INFO_GENERATE_DAT_SYM 1
#define OCR_MEMORY_INFO_GENERATE_HEX 1
#define OCR_MEMORY_INFO_HAS_BYTE_LANE 0
#define OCR_MEMORY_INFO_HEX_INSTALL_DIR QPF_DIR
#define OCR_MEMORY_INFO_MEM_INIT_DATA_WIDTH 32
#define OCR_MEMORY_INFO_MEM_INIT_FILENAME soc_system_ocr
