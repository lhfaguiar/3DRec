...
module soc_system_mm_interconnect_1 (
	...
	wire  [106:0] cmd_mux_001_src_data;                                                       // cmd_mux_001:src_data -> ILC_avalon_slave_agent:cp_data
	...
	wire  [106:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> dipsw_pio_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                      // dipsw_pio_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [7:0] cmd_mux_003_src_channel;                                                    // cmd_mux_003:src_channel -> dipsw_pio_s1_agent:cp_channel
	...
	wire  [106:0] cmd_mux_005_src_data;                                                       // cmd_mux_005:src_data -> led_pio_s1_agent:cp_data
	...
	wire  [106:0] cmd_mux_006_src_data;                                                       // cmd_mux_006:src_data -> button_pio_s1_agent:cp_data
	...
	wire  [106:0] cmd_mux_007_src_data;                                                       // cmd_mux_007:src_data -> intr_capturer_0_avalon_slave_0_agent:cp_data
	...
	wire  [106:0] ilc_avalon_slave_agent_rp_data;                                             // ILC_avalon_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [106:0] dipsw_pio_s1_agent_rp_data;                                                 // dipsw_pio_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [142:0] onchip_memory2_0_s1_agent_rp_data;                                          // onchip_memory2_0_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [106:0] led_pio_s1_agent_rp_data;                                                   // led_pio_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [106:0] button_pio_s1_agent_rp_data;                                                // button_pio_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [106:0] intr_capturer_0_avalon_slave_0_agent_rp_data;                               // intr_capturer_0_avalon_slave_0_agent:rp_data -> router_009:sink_data
	...
	wire  [106:0] mm_bridge_0_m0_limiter_cmd_src_data;                                        // mm_bridge_0_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [106:0] rsp_mux_src_data;                                                           // rsp_mux:src_data -> mm_bridge_0_m0_limiter:rsp_sink_data
	...
	wire  [106:0] fpga_only_master_master_limiter_cmd_src_data;                               // fpga_only_master_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [106:0] rsp_mux_001_src_data;                                                       // rsp_mux_001:src_data -> fpga_only_master_master_limiter:rsp_sink_data
	...
	wire  [106:0] cmd_mux_004_src_data;                                                       // cmd_mux_004:src_data -> onchip_memory2_0_s1_cmd_width_adapter:in_data
	...
	wire  [142:0] onchip_memory2_0_s1_cmd_width_adapter_src_data;                             // onchip_memory2_0_s1_cmd_width_adapter:out_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [142:0] router_006_src_data;                                                        // router_006:src_data -> onchip_memory2_0_s1_rsp_width_adapter:in_data
	...
	wire  [106:0] onchip_memory2_0_s1_rsp_width_adapter_src_data;                             // onchip_memory2_0_s1_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	...
	wire   [65:0] onchip_memory2_0_s1_agent_rdata_fifo_src_data;                              // onchip_memory2_0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	...
	soc_system_mm_interconnect_1_avalon_st_adapter_004 #(
		.inBitsPerSymbol (66),
		.inUsePackets    (0),
		.inDataWidth     (66),
		.inChannelWidth  (0),
