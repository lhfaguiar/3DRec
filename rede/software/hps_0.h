...
/*
 * Macros for device 'img', class 'altera_avalon_onchip_memory2'
 * The macros are prefixed with 'IMG_'.
 * The prefix is the slave descriptor.
 */
#define IMG_COMPONENT_TYPE altera_avalon_onchip_memory2
#define IMG_COMPONENT_NAME img
#define IMG_BASE 0xc0000000
#define IMG_SPAN 4096
#define IMG_END 0xc0000fff
#define IMG_ALLOW_IN_SYSTEM_MEMORY_CONTENT_EDITOR 0
#define IMG_ALLOW_MRAM_SIM_CONTENTS_ONLY_FILE 0
#define IMG_CONTENTS_INFO ""
#define IMG_DUAL_PORT 1
#define IMG_GUI_RAM_BLOCK_TYPE AUTO
#define IMG_INIT_CONTENTS_FILE soc_system_img
#define IMG_INIT_MEM_CONTENT 1
#define IMG_INSTANCE_ID NONE
#define IMG_NON_DEFAULT_INIT_FILE_ENABLED 0
#define IMG_RAM_BLOCK_TYPE AUTO
#define IMG_READ_DURING_WRITE_MODE DONT_CARE
#define IMG_SINGLE_CLOCK_OP 0
#define IMG_SIZE_MULTIPLE 1
#define IMG_SIZE_VALUE 4096
#define IMG_WRITABLE 1
#define IMG_MEMORY_INFO_DAT_SYM_INSTALL_DIR SIM_DIR
#define IMG_MEMORY_INFO_GENERATE_DAT_SYM 1
#define IMG_MEMORY_INFO_GENERATE_HEX 1
#define IMG_MEMORY_INFO_HAS_BYTE_LANE 0
#define IMG_MEMORY_INFO_HEX_INSTALL_DIR QPF_DIR
#define IMG_MEMORY_INFO_MEM_INIT_DATA_WIDTH 32
#define IMG_MEMORY_INFO_MEM_INIT_FILENAME soc_system_img

/*
 * Macros for device 'weights_0', class 'altera_avalon_onchip_memory2'
 * The macros are prefixed with 'WEIGHTS_0_'.
 * The prefix is the slave descriptor.
 */
#define WEIGHTS_0_COMPONENT_TYPE altera_avalon_onchip_memory2
#define WEIGHTS_0_COMPONENT_NAME weights_0
#define WEIGHTS_0_BASE 0xc0001000
#define WEIGHTS_0_SPAN 4096
#define WEIGHTS_0_END 0xc0001fff
#define WEIGHTS_0_ALLOW_IN_SYSTEM_MEMORY_CONTENT_EDITOR 0
#define WEIGHTS_0_ALLOW_MRAM_SIM_CONTENTS_ONLY_FILE 0
#define WEIGHTS_0_CONTENTS_INFO ""
#define WEIGHTS_0_DUAL_PORT 1
#define WEIGHTS_0_GUI_RAM_BLOCK_TYPE AUTO
#define WEIGHTS_0_INIT_CONTENTS_FILE soc_system_weights_0
#define WEIGHTS_0_INIT_MEM_CONTENT 1
#define WEIGHTS_0_INSTANCE_ID NONE
#define WEIGHTS_0_NON_DEFAULT_INIT_FILE_ENABLED 0
#define WEIGHTS_0_RAM_BLOCK_TYPE AUTO
#define WEIGHTS_0_READ_DURING_WRITE_MODE DONT_CARE
#define WEIGHTS_0_SINGLE_CLOCK_OP 0
#define WEIGHTS_0_SIZE_MULTIPLE 1
#define WEIGHTS_0_SIZE_VALUE 4096
#define WEIGHTS_0_WRITABLE 1
#define WEIGHTS_0_MEMORY_INFO_DAT_SYM_INSTALL_DIR SIM_DIR
#define WEIGHTS_0_MEMORY_INFO_GENERATE_DAT_SYM 1
#define WEIGHTS_0_MEMORY_INFO_GENERATE_HEX 1
#define WEIGHTS_0_MEMORY_INFO_HAS_BYTE_LANE 0
#define WEIGHTS_0_MEMORY_INFO_HEX_INSTALL_DIR QPF_DIR
#define WEIGHTS_0_MEMORY_INFO_MEM_INIT_DATA_WIDTH 32
#define WEIGHTS_0_MEMORY_INFO_MEM_INIT_FILENAME soc_system_weights_0

/*
 * Macros for device 'neuron_control_0', class 'neuron_control'
 * The macros are prefixed with 'NEURON_CONTROL_0_'.
 * The prefix is the slave descriptor.
 */
#define NEURON_CONTROL_0_COMPONENT_TYPE neuron_control
#define NEURON_CONTROL_0_COMPONENT_NAME neuron_control_0
#define NEURON_CONTROL_0_BASE 0xff200000
#define NEURON_CONTROL_0_SPAN 16
#define NEURON_CONTROL_0_END 0xff20000f
